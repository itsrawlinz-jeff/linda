...
(function ($) {
  ...
  $(function () {
    ...
    AXIMO PROJECT SLIDER JS INIT
    ------------------------------------------------------------*/
    var aximo_project_slider = new Swiper(
  ...
  gsap.from(".aximo-hero-content2 h2", {
    duration: 1.2,
    y: 50,
    opacity: 0,
    ease: "power2.out"
  ...
  gsap.from(".aximo-hero-content2 p", {
    duration: 1.2,
    y: 30,
    opacity: 0,
    delay: 0.3,
  ...
  gsap.utils.toArray(".aximo-iconbox-wrap2").forEach((card, index) => {
    gsap.from(card, {
      scrollTrigger: {
        trigger: card,
        start: "top 80%",
  ...
  gsap.utils.toArray(".aximo-service-increase-item").forEach((card, index) => {
    gsap.from(card, {
      scrollTrigger: {
        trigger: card,
        start: "top 80%",
  ...
  gsap.utils.toArray(".aximo-testimonial-wrap2").forEach((card, index) => {
    gsap.from(card, {
      scrollTrigger: {
        trigger: card,
        start: "top 80%",
  ...
  gsap.from(".aximo-about-section h2", {
    scrollTrigger: {
  ...
  gsap.from(".aximo-about-section p", {
    scrollTrigger: {
      trigger: ".aximo-about-section",
      start: "top 80%",
      toggleActions: "play none none reverse"
  ...
  gsap.from(".aximo-cta-section h2", {
    scrollTrigger: {
      trigger: ".aximo-cta-section",
      start: "top 80%",
      toggleActions: "play none none reverse"
    },
    duration: 1,
  ...
  gsap.from(".aximo-cta-section .aximo-default-btn", {
    scrollTrigger: {
      trigger: ".aximo-cta-section",
      start: "top 80%",
      toggleActions: "play none none reverse"
  ...
  ScrollTrigger.create({
    ...
    toggleClass: {className: "glass-header", targets: ".site-header"}
  });
